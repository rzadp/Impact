...
export class igEntity {
  ...
  static checkPair ( a, b ) {
    ...
    if(
      ...
      a.collides + b.collides > igEntity.COLLIDES.ACTIVE
    ) {
  ...
  static solveCollision ( a, b ) {
    ...
    var weak = null;
    if(
      a.collides == igEntity.COLLIDES.LITE ||
      b.collides == igEntity.COLLIDES.FIXED
    ) {
      weak = a;
    }
    else if(
      b.collides == igEntity.COLLIDES.LITE ||
      a.collides == igEntity.COLLIDES.FIXED
    ) {
      weak = b;
    }
