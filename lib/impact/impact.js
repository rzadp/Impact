...
ig.main = function( canvasId, gameClass, fps, width, height, scale, loaderClass, systemClass, inputClass ) {
	ig.system = new (systemClass || igSystem)( canvasId, fps, width, height, scale || 1 );
	ig.input = new (inputClass || igInput)();
