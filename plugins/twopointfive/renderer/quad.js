...
export class tpfQuad {
  constructor (width, height, texture) {
    ...
    this._dirty = true;
    this._verts = new Float32Array(tpfQuad.SIZE);
    ...
    this._recalcPositions = function() {
      ...
      var m = mat4.identity(tpfQuad._workMatrix);
  ...
  static setUVInBuffer (buffer, offset, x1, y1, x2, y2) {
    var b = offset * tpfQuad.SIZE;
    var v = buffer;
  ...
  static VERTICES = 6;
  static SIZE = tpfQuad.VERTEX_SIZE * tpfQuad.VERTICES;
};
...
if( !ig.global.wm ) {
	tpfQuad._workMatrix = mat4.create();
}
